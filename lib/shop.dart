      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'Icon metro-trophy' (shape)
                PageLink(
              links: [
                PageLinkInfo(
