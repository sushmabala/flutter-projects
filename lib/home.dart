                ...
                children: <Widget>[
                  Pinned.fromSize(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        border: Border.all(
                            width: 1.0, color: const Color(0xffe6125f)),
                      ),
                    ),
                  ),
                  Pinned.fromSize(
